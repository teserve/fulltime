...
try {
  ...
  // $conn->exec("insert into User (username, pass, email, cell, fir_name, las_name) values ('firstuserever', '" . $hash . "', 'email@gmail.com', '1234567890', 'group7', 'isthebest')");

  // if ($_POST["account_type"] == "student") {
  //   // student table insertion
  // } elseif ($_POST["account_type"] == "employee") {
