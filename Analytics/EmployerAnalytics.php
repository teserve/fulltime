...
<!--
  ...
  <!-- header-starts -->
  <!-- <div class="navbar custom-navbar navbar-fixed-top" style="background-color:black;">
              ...
              <li class="dropdown profile_details_drop">
                ...
                <ul class="dropdown-menu drp-mnu" aria-labelledby="dropdownMenu3">
                  <li class="user-info">
                    ...
                    <span class="status ml-2">Supply Chain Manager</span>
                  </li>
                  <li> <a href="#"><i class="lnr lnr-user"></i>Profile</a> </li>
                  <li> <a href="#"><i class="lnr lnr-users"></i>Matches</a> </li>
                  <li> <a href="#"><i class="lnr lnr-briefcase"></i>Jobs</a> </li>
          ...
          <div class="row">
            <div class="col-sm-6 pr-sm-2 statistics-grid">
              <div class="card card_border border-primary-top p-4">
                ...
                <p class="stat-text">Total Views</p>
              </div>
            </div>
